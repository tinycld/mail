        ...
        messages: [
            {
                ...
                body_html:
                    '<p><strong>Your weekly digest</strong></p><p>This week in the TinyCld Community:</p><ul><li>12 new discussions</li><li>3 resolved issues</li><li>New guide: "Integrating with Zapier"</li><li>Most discussed: "Best practices for backup setups"</li></ul>',
            },
        ],
    },
    {
    ...
    },
    {
        ...
        messages: [
            ...
            },
            {
                ...
                subject: 'Re: Hippo conservation status update',
                snippet:
                    'Attaching the photo I took last month for the newsletter — feel free to use it.',
                body_html:
...
async function seedThreadsForMailbox(
    ...
    for (const thread of threads) {
        ...
        for (let i = 0; i < thread.messages.length; i++) {
            ...
            const attachmentFiles = (msg.attachments ?? []).map(name =>
                fixtureFile(name, mimeFromName(name))
            )
