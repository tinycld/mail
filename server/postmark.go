...
// Configured reports whether a server token is set. Without it, Send and the
// domain/inbound API checks fail (they call the Postmark API), even though
// inbound webhook parsing still works — see newProviderByName.
